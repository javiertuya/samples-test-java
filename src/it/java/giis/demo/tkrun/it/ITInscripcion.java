...
public class ITInscripcion {
	...
	/**
	 * Seleccion en la tabla de carreras. Comprueba detalles de la tabla de carreras, seleccion, detalle y porcentaje de
	 * descuento
	 */
	@Test
	...
	public void testCarreraValidate() {
		...
		optionPane.requireTitle("Informacion").requireMessage("Formato ISO incorrecto para fecha: 2016-1110")
